...
namespace Bunq.Sdk.Model.Generated.Object
{
    /// <summary>
    /// </summary>
    public class SchedulePaymentEntryObject : BunqModel
    {
        /// <summary>
        ...
        public SchedulePaymentEntryObject(AmountObject amount, MonetaryAccountReference counterpartyAlias, string description)
        {
            Amount = amount;
        ...
        /// <summary>
        /// </summary>
        public static SchedulePaymentEntryObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<SchedulePaymentEntryObject>(json);
        }
    }
}
