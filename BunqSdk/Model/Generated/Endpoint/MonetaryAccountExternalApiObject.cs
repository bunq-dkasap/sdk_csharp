...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class MonetaryAccountExternalApiObject : BunqModel
    {
        ...
        /// <summary>
        /// The transaction spending limit Amount of the MonetaryAccountExternal. Defaults to null. Currency must match
        /// the MonetaryAccountExternal's currency. Limited to 10000 EUR.
        /// </summary>
        ...
        /// <param name="transactionLimit">The transaction spending limit Amount of the MonetaryAccountExternal. Defaults to null. Currency must match the MonetaryAccountExternal's currency. Limited to 10000 EUR.</param>
