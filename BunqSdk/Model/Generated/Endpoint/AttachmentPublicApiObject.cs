...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class AttachmentPublicApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// </summary>
        public static BunqResponse<AttachmentPublicApiObject> Get(string attachmentPublicUuid, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<AttachmentPublicApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static AttachmentPublicApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<AttachmentPublicApiObject>(json);
        }
    }
}
