...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_CONTENT, content},
        ...
        /// </summary>
        public static BunqResponse<List<NoteTextMasterCardActionApiObject>> List(int mastercardActionId, int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextMasterCardActionApiObject> Get(int mastercardActionId, int noteTextMasterCardActionId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
