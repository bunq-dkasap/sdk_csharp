...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ConfirmationOfFundsApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<ConfirmationOfFundsApiObject> Create(PointerObject pointerIban, AmountObject amount, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_AMOUNT, amount},
            ...
            return FromJson<ConfirmationOfFundsApiObject>(responseRaw, OBJECT_TYPE_POST);
        }
        ...
        /// <summary>
        /// </summary>
        public static ConfirmationOfFundsApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ConfirmationOfFundsApiObject>(json);
        }
    }
}
