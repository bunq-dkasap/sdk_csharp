...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ScheduleUserApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// </summary>
        public static BunqResponse<List<ScheduleUserApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<ScheduleUserApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static ScheduleUserApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ScheduleUserApiObject>(json);
        }
    }
}
