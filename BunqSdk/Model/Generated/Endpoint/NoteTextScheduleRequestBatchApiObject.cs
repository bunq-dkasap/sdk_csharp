...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_CONTENT, content},
        ...
        /// </summary>
        public static BunqResponse<List<NoteTextScheduleRequestBatchApiObject>> List(int scheduleRequestInquiryBatchId, int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextScheduleRequestBatchApiObject> Get(int scheduleRequestInquiryBatchId, int noteTextScheduleRequestBatchId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
