...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class SandboxUserPersonApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<SandboxUserPersonApiObject> Create( IDictionary<string, string> customHeaders = null)
        {
            ...
            var requestMap = new Dictionary<string, object>
    {
            ...
            return FromJson<SandboxUserPersonApiObject>(responseRaw, OBJECT_TYPE_POST);
        }
        ...
        /// <summary>
        /// </summary>
        public static SandboxUserPersonApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<SandboxUserPersonApiObject>(json);
        }
    }
}
