...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class AvatarApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_ATTACHMENT_PUBLIC_UUID, attachmentPublicUuid},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<AvatarApiObject> Get(string avatarUuid, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<AvatarApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static AvatarApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<AvatarApiObject>(json);
        }
    }
}
