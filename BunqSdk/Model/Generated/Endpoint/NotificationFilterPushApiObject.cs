...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class NotificationFilterPushApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public List<NotificationFilterPushObject> NotificationFilters { get; set; }
    
        /// <summary>
        /// </summary>
        /// <param name="notificationFilters">The types of notifications that will result in a push notification for this user.</param>
        public static BunqResponse<NotificationFilterPushApiObject> Create(List<NotificationFilterPushObject> notificationFilters = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_NOTIFICATION_FILTERS, notificationFilters},
            ...
            return FromJson<NotificationFilterPushApiObject>(responseRaw, OBJECT_TYPE_POST);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<List<NotificationFilterPushApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<NotificationFilterPushApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static NotificationFilterPushApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<NotificationFilterPushApiObject>(json);
        }
    }
}
