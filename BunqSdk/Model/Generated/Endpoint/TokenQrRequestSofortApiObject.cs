...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class TokenQrRequestSofortApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<TokenQrRequestSofortApiObject> Create(string token, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_TOKEN, token},
            ...
            return FromJson<TokenQrRequestSofortApiObject>(responseRaw, OBJECT_TYPE_POST);
        }
        ...
        /// <summary>
        /// </summary>
        public static TokenQrRequestSofortApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<TokenQrRequestSofortApiObject>(json);
        }
    }
}
