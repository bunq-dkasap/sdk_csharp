...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class NotificationFilterEmailApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public List<NotificationFilterEmailObject> NotificationFilters { get; set; }
    
        /// <summary>
        /// </summary>
        /// <param name="notificationFilters">The types of notifications that will result in a email notification for this user.</param>
        public static BunqResponse<NotificationFilterEmailApiObject> Create(List<NotificationFilterEmailObject> notificationFilters = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_NOTIFICATION_FILTERS, notificationFilters},
            ...
            return FromJson<NotificationFilterEmailApiObject>(responseRaw, OBJECT_TYPE_POST);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<List<NotificationFilterEmailApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<NotificationFilterEmailApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static NotificationFilterEmailApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<NotificationFilterEmailApiObject>(json);
        }
    }
}
