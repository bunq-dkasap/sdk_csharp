...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class CardBatchReplaceApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public List<CardBatchReplaceEntryObject> Cards { get; set; }
        /// <summary>
        /// The ids of the cards that have been replaced.
        /// </summary>
        [JsonProperty(PropertyName = "updated_card_ids")]
        public List<BunqIdObject> UpdatedCardIds { get; set; }
    
        /// <summary>
        /// </summary>
        /// <param name="cards">The cards that need to be replaced.</param>
        public static BunqResponse<CardBatchReplaceApiObject> Create(List<CardBatchReplaceEntryObject> cards, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_CARDS, cards},
            ...
            return FromJson<CardBatchReplaceApiObject>(responseRaw, OBJECT_TYPE_POST);
        }
        ...
        /// <summary>
        /// </summary>
        public static CardBatchReplaceApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CardBatchReplaceApiObject>(json);
        }
    }
}
