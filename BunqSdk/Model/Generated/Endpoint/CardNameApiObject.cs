...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// Surname or Surname.
    /// </summary>
    public class CardNameApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// </summary>
        public static BunqResponse<List<CardNameApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<CardNameApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static CardNameApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CardNameApiObject>(json);
        }
    }
}
