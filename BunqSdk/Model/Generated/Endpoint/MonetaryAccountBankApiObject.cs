...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_COUNTRY_IBAN, countryIban},
        ...
        /// </summary>
        public static BunqResponse<MonetaryAccountBankApiObject> Get(int monetaryAccountBankId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// <param name="displayName">The legal name of the user / company using this monetary account.</param>
        /// <param name="setting">The settings of the MonetaryAccountBank.</param>
        public static BunqResponse<int> Update(int monetaryAccountBankId, string description = null, AmountObject dailyLimit = null, string avatarUuid = null, string status = null, string subStatus = null, string reason = null, string reasonDescription = null, string displayName = null, MonetaryAccountSettingObject setting = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
