...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_CONTENT, content},
        ...
        /// </summary>
        public static BunqResponse<List<NoteTextSchedulePaymentBatchApiObject>> List(int schedulePaymentBatchId, int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextSchedulePaymentBatchApiObject> Get(int schedulePaymentBatchId, int noteTextSchedulePaymentBatchId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
