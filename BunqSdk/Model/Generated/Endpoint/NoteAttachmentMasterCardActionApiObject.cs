...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_DESCRIPTION, description},
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentMasterCardActionApiObject>> List(int mastercardActionId, int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentMasterCardActionApiObject> Get(int mastercardActionId, int noteAttachmentMasterCardActionId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
